        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            <Link to="/" className="flex items-center space-x-2 mb-6 group" aria-label="MOMENTUM Home">
              <img src="/logo.jpeg" alt="MOMENTUM" className="w-10 h-10 rounded-xl group-hover:shadow-lg group-hover:shadow-indigo-500/30 transition-all duration-300 object-cover" />
