    ...
    <div className="flex h-screen bg-gray-50/80 overflow-hidden">
      ...
      >
        ...
        <div className={`py-5 border-b border-gray-100 ${sidebarCollapsed ? 'px-3' : 'px-5'}`}>
          <Link to="/" className="flex items-center gap-2.5" aria-label="LifeFlow Home">
            <div className="w-9 h-9 bg-linear-to-br from-indigo-500 to-purple-600 rounded-xl flex items-center justify-center shadow-md shadow-indigo-200/50 shrink-0">
              <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
              </svg>
            </div>
            {!sidebarCollapsed && (
              <span className="text-lg font-bold bg-linear-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">LifeFlow</span>
            )}
          </Link>
        </div>
